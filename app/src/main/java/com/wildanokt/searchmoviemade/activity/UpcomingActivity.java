...
import com.wildanokt.searchmoviemade.adapter.MovieUpcomingAdapter;
import com.wildanokt.searchmoviemade.loader.UpcomingAsyncTaskLoader;
...
public class UpcomingActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<MovieItems>> {
    ...
    private MovieUpcomingAdapter rvAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pgUpcoming = findViewById(R.id.pgUpcoming);

        //init load
        getSupportLoaderManager().initLoader(0, null, this);

        //recycler
        rvAdapter = new MovieUpcomingAdapter(this);
        rvAdapter.notifyDataSetChanged();

        rvMovie = findViewById(R.id.rv_movie_upcoming);
        ...
        navigation.setSelectedItemId(R.id.navigation_upcoming);

        //action bar
        String actionBar = String.format(getResources().getString(R.string.action_bar_upcoming));
    ...
    public Loader<ArrayList<MovieItems>> onCreateLoader(int i, @Nullable Bundle bundle) {
        ...
        return new UpcomingAsyncTaskLoader(this);
    }
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.navigation_now:
                    Intent intent2 = new Intent(UpcomingActivity.this, NowPlayingActivity.class);
                    startActivity(intent2);
                    return true;
                case R.id.navigation_upcoming:
                    return true;
                case R.id.navigation_favorite:
                    Intent intent3 = new Intent(UpcomingActivity.this, FavoriteActivity.class);
